---
title: How to build a self-study roadmap when no teacher is there to tell you what to do next
primary_keyword: how do i create a self-study plan
meta_description: Build a self-study roadmap from scratch with a simple framework for goals, resources, practice, and review when no teacher is guiding you.
status: draft
---
...
2. What should I be able to do by week 4?
3. What proof will show I’ve reached the goal?
...
1. Pick one outcome you can finish in 12 weeks.
2. Break it into 3–5 milestones.
3. Choose one basic resource, one example source, and one practice source.
4. Set a short weekly learning block plus one review block.
